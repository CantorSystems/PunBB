...
'User has posted label'			=> 'Отображать точку перед индикатором состояния темы, если пользователь отвечал в ней ранее. Отключите функцию, если нагрузка на сервер высока.',
