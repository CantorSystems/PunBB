...
// Report
'No reason' 				=> 'Необходимо ввести причину жалобы.',
'Report flood'				=>	'Должно пройти не менее %s секунд между жалобами модератору. Пожалуйста, подождите немного и попробуйте ещё раз.',
'Report redirect'   		=> 'Жалоба отправлено.',
'Report post'   			=> 'Жалоба на сообщение',
'Reason'					=> 'Причина',
'Reason help'   			=> 'Причина, по которой вы жалуетесь на сообщение',
'Too long reason'			=> 'Длина вашей жалобы — %s байт. Это превышает лимит форума в %s байт.',
'Report errors'   			=> '<strong>Внимание!</strong> Для отправки жалобы нужно исправить следующие ошибки:',
